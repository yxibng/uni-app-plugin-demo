...
#ifndef OBJECTDETECTOR_SWIFT_H
#define OBJECTDETECTOR_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="ObjectDetector",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@class UIView;
SWIFT_CLASS("_TtC14ObjectDetector13CameraManager")
@interface CameraManager : NSObject <AVCaptureVideoDataOutputSampleBufferDelegate>
- (void)drawBoxes:(NSArray<NSValue *> * _Nonnull)boxes pixelBuffer:(CVPixelBufferRef _Nonnull)pixelBuffer;
@property (nonatomic, weak) id <CameraManagerDelegate> _Nullable delegate;
@property (nonatomic, strong) UIView * _Nullable previewView;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
- (void)startSession;
- (void)stopSession;
- (void)switchCameraWithIsFront:(BOOL)isFront;
- (void)switchFlashWithOpen:(BOOL)open;
- (void)setZoomLevel:(float)level;
@end

@class AVCaptureOutput;
@class AVCaptureConnection;
@interface CameraManager (SWIFT_EXTENSION(ObjectDetector))
- (void)captureOutput:(AVCaptureOutput * _Nonnull)output didOutputSampleBuffer:(CMSampleBufferRef _Nonnull)sampleBuffer fromConnection:(AVCaptureConnection * _Nonnull)connection;
@end

SWIFT_PROTOCOL("_TtP14ObjectDetector21CameraManagerDelegate_")
...
@class NSCoder;
SWIFT_CLASS("_TtC14ObjectDetector24CameraManagerPreviewView")
@interface CameraManagerPreviewView : UIView
...
SWIFT_CLASS("_TtC14ObjectDetector14VisionDetector")
@interface VisionDetector : NSObject
@property (nonatomic, weak) id <VisionDetectorDelegate> _Nullable delegate;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
- (void)detectWithPixelBuffer:(CVPixelBufferRef _Nonnull)pixelBuffer;
@end

@class NSString;
@class UIImage;
SWIFT_PROTOCOL("_TtP14ObjectDetector22VisionDetectorDelegate_")
@protocol VisionDetectorDelegate <NSObject>
